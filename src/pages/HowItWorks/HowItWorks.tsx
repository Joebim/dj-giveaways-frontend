    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-32 bg-gray-50 border-b border-gold-primary/20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <motion.p
            className="text-xl text-gray-700 font-light max-w-3xl"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => {
              ...
              return (
                <motion.div
                  key={step.title}
                  className="bg-gray-50 border border-gold-primary/20 rounded-2xl p-8 hover:border-gold-primary/50 transition-all duration-300"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <h3 className="text-2xl font-light text-navy-primary mb-4">{step.title}</h3>
                  <p className="text-gray-700 font-light leading-relaxed">{step.description}</p>
                </motion.div>
              );
            })}
          </div>
      ...
      {/* Why Choose Us */}
      <section className="py-20 bg-gray-50 border-y border-gold-primary/20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-4xl font-light text-navy-primary mb-6">Why thousands choose DJ Giveaways</h2>
          ...
          >
            {features.map((feature) => (
              <div
                key={feature.title}
                className="bg-white border border-gold-primary/20 rounded-xl p-6 hover:border-gold-primary/40 transition-all duration-300"
              >
                <h3 className="text-xl font-light text-navy-primary mb-2">{feature.title}</h3>
                <p className="text-gray-700 font-light leading-relaxed">{feature.body}</p>
              </div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[900px] mx-auto px-6 lg:px-12 text-center">
          <motion.div
            className="bg-gray-50 border border-gold-primary/30 rounded-2xl p-12 shadow-lg shadow-gold-primary/10"
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <h3 className="text-3xl font-light text-navy-primary mb-4">Ready to become our next champion?</h3>
